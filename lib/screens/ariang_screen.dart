...
class AriaNgScreen extends StatefulWidget {
  const AriaNgScreen({super.key});

  @override
  State<AriaNgScreen> createState() => _AriaNgScreenState();
}

class _AriaNgScreenState extends State<AriaNgScreen> {
  ...
  String get _ariangUrl {
    // 构建 AriaNg URL（从 API 配置中获取基础 URL）
    final baseUrl = ApiConfig.baseUrl.replaceAll('/api', '');
    return '$baseUrl/ariang/';
  }
